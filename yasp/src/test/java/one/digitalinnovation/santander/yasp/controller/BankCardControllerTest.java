...
import one.digitalinnovation.santander.yasp.common.dto.entity.CreditCard;
import one.digitalinnovation.santander.yasp.common.dto.entity.DebitCard;
import one.digitalinnovation.santander.yasp.common.dto.entity.MealCard;
...
public class BankCardControllerTest {
    ...
    @Test
    @DisplayName("Should receive not found when card is not exist")
    void shouldReceiveBadRequestWhenCardDoesNotExist() throws Exception {
    ...
    void shouldReturnTaxesWhenIsValidCreditCard() throws Exception {
        //Given
    ...
    void shoudReturnNoTaxesWhenIsValidCreditCardAndCustomerHasUsedIThisMonth() throws Exception {
        //Given
        final BankCard card = CreditCard.builder()
                .withId(1L)
                .withMonthlyTax(10D)
